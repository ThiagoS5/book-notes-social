...
import { cn } from '@/lib/utils/twMerge' // Supondo que seu cn está em @/lib/utils
    ...
    return (
      <input
        ...
        className={cn(
          ...
          'dark:border-slate-700 dark:placeholder:text-slate-400 dark:focus-visible:ring-indigo-400',
          className
        )}
        ref={ref}
        {...props}
